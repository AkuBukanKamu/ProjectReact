...
function EditMurid() {
    ...
    const fetchDataMurid = async () => {
        await axios.get(`http://127.0.0.1:8000/api/murid/show/${id}`).then(({data})=>{
        const { unit, nama, namaguru, umur, nohp, alamat, spp, tanggalmasuk } = data.murid
            setUnit(unit)
            setNama(nama)
    ...
    const updateMurid = async (e) => {
        ...
        await axios.post(`http://127.0.0.1:8000/api/murid/update/${id}`, formData).then(({data})=>{
        Swal.fire({
            icon:"success",
            text:data.message
        })
                                ...
                                <div class="card mb-12">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <Link className="btn btn-danger" to={"/datamurid"}><i className="bx bx-undo"></i> Cancel</Link>
                                        </div>
