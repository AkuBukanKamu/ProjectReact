...
function CreateGuru() {
  ...
  const CreateGuru = async (e) => {
    ...
    formData.append('tanggallahir', tempatlahir)
    formData.append('no_hp', no_hp)
    formData.append('gaji', gaji)
    formData.append('tanggalmasuk', tanggalmasuk)

    await axios.post('http://127.0.0.1:8000/api/guru/store', formData).then(({data}) => {
        Swal.fire({
            icon:"success",
            text:data.message
        })
          ...
          <div class="layout-page">
              ...
              <div class="content-wrapper">
                  <div class="container-xxl flex-grow-1 container-p-y">
                      <h4 class="fw-bold py-3 mb-4">Create Data Guru</h4>
                      <div class="row">
                          <div class="col-xl">
                              <div class="card mb-12">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <Form.Control type="string" placeholder="Tempat Lahir ..." required value={tempatlahir} onChange={(event)=>{setTempatlahir(event.target.value)}}/>
                                      </div>
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <Form.Control type="bigInteger" placeholder="No Handphone ..." required value={no_hp} onChange={(event)=>{setNo_hp(event.target.value)}}/>
                                      </div>
                                      ...
                                      <div class="mb-3">
                                            ...
                                            <InputGroup className="mb-3">
                                                ...
                                                <Form.Control type="bigInteger" placeholder="Gaji ..." required value={gaji} onChange={(event)=>{setGaji(event.target.value)}} />
                                            </InputGroup>
                                      </div>
                                  ...
                                  <div class="card-footer">
                                      ...
                                      <Link className="btn btn-danger" to={"/guru"}><i className="bx bx-undo"></i> Cancel</Link>
                                  </div>
                                  </Form>
                              </div>
                          </div>        
